...
/**
 * Returns the size in bits of the UTF-8 sequence or -1, if there
 * is no valid sequence at that position.
 *
 * @param {BitArray} bitArray
 * @param {number} start
 * @returns {number}
...
/**
 * Returns the size in bits of the UTF-16 sequence or -1, if there
 * is no valid sequence at that position.
 *
 * @param {BitArray} bitArray
 * @param {number} start
...
/**
 * Returns the size in bits of the UTF-32 sequence or -1, if there
 * is no valid sequence at that position.
 *
 * @param {BitArray} bitArray
 * @param {number} start
