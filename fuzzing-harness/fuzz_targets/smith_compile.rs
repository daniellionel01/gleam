...
//
// Fuzz target 2 (type-directed): raw bytes drive fuzzing-core to build a
...
//   generator itself (see Ctx::protected in fuzzing-core), not filtered
//   here.
// - generated program doesn't compile: GENERATOR BUGS (fuzzing-core's
